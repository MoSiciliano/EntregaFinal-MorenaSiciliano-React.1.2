...
const ItemListContainer = () => {
  ...
  const products = [
    ...
    { id: 107, name: "Ventana Corrediza con celosia moderna", category: "corrediza", description: "Conoce nuestras ventanas paños fijos,  contamos con tamaños estándar y a medida", price: 100, stock: 20, img: Corrediza4 },
